...
namespace Microsoft.ProjectOxford.Face
{
    ...
    public class FaceServiceClient : IFaceServiceClient
    {
        ...
        public async Task<Face[]> DetectAsync(string url, bool analyzesFaceLandmarks = false, bool analyzesAge = true, bool analyzesGender = false, bool analyzesHeadPose = false)
        {
            var requestUrl = string.Format(
                "{0}/detect?returnFaceId=false&returnFaceLandmarks=false&returnFaceAttributes=Age&{6}={7}",
                ServiceHost,
                DetectionsQuery,
        ...
        /// <param name="analyzesHeadPose">If set to <c>true</c> [analyzes head pose].</param>
        /// <returns>The detected faces.</returns>
        public async Task<Face[]> DetectAsync(Stream imageStream, bool analyzesFaceLandmarks = false, bool analyzesAge = true, bool analyzesGender = true, bool analyzesHeadPose = false)
        {
            var requestUrl = string.Format(
                // "{0}/{1}?analyzesFaceLandmarks={2}&analyzesAge={3}&analyzesGender={4}&analyzesHeadPose={5}&{6}={7}",
                "{0}/detect?returnFaceId=false&returnFaceLandmarks=false&returnFaceAttributes=Age,Gender,Smile,facialHair,Glasses&{2}={3}",
                ServiceHost,
                DetectionsQuery,
                SubscriptionKeyName,
                this.subscriptionKey);
        ...
        public async Task<Face[]> EmotionAsync(Stream imageStream, bool analyzesFaceLandmarks = false, bool analyzesAge = true, bool analyzesGender = true, bool analyzesHeadPose = false)
        {
            var requestUrl = string.Format(
                // "{0}/{1}?analyzesFaceLandmarks={2}&analyzesAge={3}&analyzesGender={4}&analyzesHeadPose={5}&{6}={7}",
                "{0}/detect?returnFaceId=false&returnFaceLandmarks=false&returnFaceAttributes=Age,Gender,Smile,facialHair,Glasses&{2}={3}",
